...
New-ExecutableToCall -Name "KeyCloak Cert" -Tag PreBuild -ScriptBlock {
...
New-ExecutableToCall -Name "Start (or restart) Keycloak docker instance" -Tag PreBuild -ScriptBlock {
